...
+ (id)sharedCache {
    ...
    dispatch_once(&pred, ^{
        ...
        // Defaults
        [_sharedObject setAnnotationType:ZSPinAnnotationTypeStandard];
...
+ (void)setPinAnnotationType:(ZSPinAnnotationType)type {
    [[ZSPinAnnotation sharedCache] setAnnotationType:type];
}//end


/**
 * Draw the pin with HEX color and type
 *
 * @version $Revision: 0.1
 */
+ (UIImage *)pinAnnotationWithHexString:(NSString *)hexString type:(ZSPinAnnotationType)type {
    [self setPinAnnotationType:type];
    return [self pinAnnotationWithHexString:hexString];
}//end
...
/**
 * Draws a pin of the specified color and type
 *
 * @version $Revision: 0.1
 */
 ...
 * @version $Revision: 0.1
 */
+(UIImage *)pinAnnotationWithImage: (UIImage *)setImage
{
...
+ (UIImage *)pinAnnotationWithColor:(UIColor *)color {
    ...
    ZSPinAnnotationType type = [[ZSPinAnnotation sharedCache] annotationType];
    ...
    if (type == ZSPinAnnotationTypeStandard) {
        ...
        CGGradientRef stickGradient = CGGradientCreateWithColors(colorSpace, ( CFArrayRef)stickGradientColors, stickGradientLocations);
        ...
        CGGradientRef vertStickGradient = CGGradientCreateWithColors(colorSpace, ( CFArrayRef)vertStickGradientColors, vertStickGradientLocations);
        ...
        CGFloat shadow3BlurRadius = 4.5;
        
        //// Bezier Drawing
        UIBezierPath* bezierPath = [UIBezierPath bezierPath];
        [bezierPath moveToPoint: CGPointMake(11.76, 18.38)];
        [bezierPath addCurveToPoint: CGPointMake(11.76, 9.81) controlPoint1: CGPointMake(9.41, 16.01) controlPoint2: CGPointMake(9.41, 12.17)];
        [bezierPath addCurveToPoint: CGPointMake(20.24, 9.81) controlPoint1: CGPointMake(14.1, 7.44) controlPoint2: CGPointMake(17.9, 7.44)];
        [bezierPath addCurveToPoint: CGPointMake(20.24, 18.38) controlPoint1: CGPointMake(22.59, 12.17) controlPoint2: CGPointMake(22.59, 16.01)];
        [bezierPath addCurveToPoint: CGPointMake(11.76, 18.38) controlPoint1: CGPointMake(17.9, 20.74) controlPoint2: CGPointMake(14.1, 20.74)];
        [bezierPath closePath];
        [bezierPath moveToPoint: CGPointMake(16, 34.5)];
        [bezierPath addCurveToPoint: CGPointMake(26, 14.6) controlPoint1: CGPointMake(15.99, 34.51) controlPoint2: CGPointMake(26, 20.17)];
        [bezierPath addCurveToPoint: CGPointMake(16, 4.5) controlPoint1: CGPointMake(26, 9.02) controlPoint2: CGPointMake(21.52, 4.5)];
        [bezierPath addCurveToPoint: CGPointMake(6, 14.6) controlPoint1: CGPointMake(10.48, 4.5) controlPoint2: CGPointMake(6, 9.02)];
        [bezierPath addCurveToPoint: CGPointMake(16, 34.5) controlPoint1: CGPointMake(6, 20.17) controlPoint2: CGPointMake(16, 34.5)];
